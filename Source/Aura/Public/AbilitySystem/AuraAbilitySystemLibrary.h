...
public:
	...
	static void SetIsBlockedHit(UPARAM(ref) FGameplayEffectContextHandle& EffectContextHandle, bool NewIsBlockedHit);

	//Blueprint function non const = output pin standard...
	//UPARAM(ref) determines non const input pin...
	UFUNCTION(BlueprintCallable, Category="AuraAbilitySystemLibrary|GameplayEffects")
	static void SetIsCriticalHit(UPARAM(ref) FGameplayEffectContextHandle& EffectContextHandle, bool NewIsCriticalHit);
};
